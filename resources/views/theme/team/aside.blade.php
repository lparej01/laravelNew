 <!--Aside  MENU LATERAL-->
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 card"
     id="sidenav-main">
     <div class="sidenav-header">
         ...
         <a  href="{{ route('inicio') }}" target="_blank">
             ...
             <span class="ms-1 font-weight-bold">SEASC</span>
         </a>
     </div>
     ...
     <div class="sidenav-header">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary mt-3 w-80" href="{{ route('inicio') }}">Inicio</a>
    </div>
