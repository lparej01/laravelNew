...
<footer class="footer pt-3  ">
  ...
  <div id="custom_html-3" class="widget_text col pb-0 widget widget_custom_html">
    <div class="textwidget custom-html-widget">
      <p style="text-align: center;"><img class="aligncenter  wp-image-13" src="https://alimentoslagiralda.com/wp-content/uploads/2021/01/La-Giralda.svg" alt="" width="130" height="74"></p>
  ...
  <a href="#top" class="back-to-top button icon invert plain fixed bottom z-1 is-outline round left hide-for-medium active" id="top-link"><i class="icon-angle-up"></i></a>
  </footer>
