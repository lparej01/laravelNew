...
<div class="container-fluid">
        <div class="col-sm-12" >                  
             <x-tables.bo-table :data="$movTer" title="LISTA DE MOVIMIENTOS DE PRODUCTOS" data-id="dtHorizontalExample" data-toolbar="#toolbar"
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{asset("assets/team/scripts/tables/abastecimiento/produccion/mov_productos.js")}}"></script>
                                @endpush                             
