...
<div class="container-fluid">
        <div class="col-sm-12" >                  
             <x-tables.bo-table :data="$plan" title="LISTA DE PLANES DE ENTREGA" data-id="dtHorizontalExample" data-toolbar="#toolbar"
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{asset("assets/team/scripts/tables/abastecimiento/produccion/planes_entrega.js")}}"></script>
                                @endpush                             
