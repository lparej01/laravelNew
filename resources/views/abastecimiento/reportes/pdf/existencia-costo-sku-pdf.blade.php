...
<body>
  ...
  <div class="container-fluid py-4">  
    ...
    <table>
      <tr>
          ...
          <h3>Reporte de existencia por costo sku  </h3>
          </td>
      </tr>
    </table>  
  </div>
  <div class="container-fluid py-4">
    <header>
      <h2>Existencia de productos segun su costo sku</h2>
  </header>
      ...
      <tbody>
          @foreach ($existencia as $item)
              <tr><td>{{$item->sku}}</td>
                  ...
                  <td>{{$item->periodo}}</td>
                  <td style="width: 50px">{{$item->invFinal}}</td>                 
                  <td style="width: 80px" >{{$item->costoUnitario}}</td>
