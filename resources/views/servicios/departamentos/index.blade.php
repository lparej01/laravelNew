...
<div class="container-fluid">           
    <div class="col-sm-12" >       
             ...
             <x-tables.bo-table :data="$departamentos" title="LISTA DE DEPARTAMENTOS" data-id="dtHorizontalExample" data-toolbar="#toolbar"
                                ...
                                <x-slot:headerActions>
                                    ...
                                    <div class="float-right" >
                                         @if ($actionsBlade->can_create > 0)
                                            <a href="{{ route('crear.departamentos') }}" class="btn btn-primary float-right"
                                                data-placement="left">
                                                {{ __('Crear Nuevo Departamento') }}
                                            </a>
                                        @endif

                                        <x-notify.modal x-data="{ id: tableControlles.idRow }" id-modal="modalDepartamentos">
                                            <x-slot:modalTitle>
                                                <h4 class="text-lg">Departamentos</h4>
                                            </x-slot:modalTitle>
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{asset("assets/team/scripts/tables/servicios/soportetecnico/departamentos.js")}}"></script>
                                @endpush                             
