...
<div class="box box-info padding-1">
    <div class="box-body">
            <div class="col-lg-6">
                {{ Form::label('Marca (*)') }}
                {{ Form::text('marca', null, ['class' => 'form-control' . ($errors->has('marca') ? ' is-invalid' : ''),  "id" => "marca","name" => "marca","onKeyPress"=> "if(this.value.length==50) return false;" ,'placeholder' => 'Marca del Equipo']) }}
...
<div class="box box-info padding-1">
    <div class="box-body">
        <div class="form-check form-switch">
            <input class="form-check-input"     type="radio"     name ="mouse"  id="mouse" value=1  checked >
         <label class="form-check-label" for="flexSwitchCheckDefault">Mouse </label>
    </div>          
          
    <div class="box-body">
        <div class="form-check form-switch">
            <input class="form-check-input" type="radio" name ="mouse"  id="mouse" value=0  CheckState >
         <label class="form-check-label" for="flexSwitchCheckDefault">No tiene</label>
    </div>  
