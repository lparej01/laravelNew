...
<div class="container-fluid">           
    <div class="col-sm-12" >       
             ...
             <x-tables.bo-table :data="$asignacion" title="LISTA DE EQUIPOS" data-id="dtHorizontalExample" data-toolbar="#toolbar"
                                ...
                                <x-slot:headerActions>
                                    ...
                                    <div class="float-right" >
                                         @if ($actionsBlade->can_create > 0)
                                            <a href="{{ route('crear.asignacion') }}" class="btn btn-primary float-right"
                                                data-placement="left">
                                                {{ __('Crear Nueva Asignacion Equipo') }}
                                            </a>
                                        @endif

                                        <x-notify.modal x-data="{ id: tableControlles.idRow }" id-modal="modalAsignacion">
                                            <x-slot:modalTitle>
                                                <h4 class="text-lg">Equipos</h4>
                                            </x-slot:modalTitle>
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{asset("assets/team/scripts/tables/servicios/asignacion/asignacion.js")}}"></script>
                                @endpush                             
