...
<div class="container-fluid">           
    <div class="col-sm-12" >       
             ...
             <x-tables.bo-table :data="$incidencias" title="LISTA DE INCIDENCIAS" data-id="dtHorizontalExample" data-toolbar="#toolbar"
                                ...
                                <x-slot:headerActions>
                                    ...
                                    <div class="float-right" >
                                         @if ($actionsBlade->can_create > 0)
                                            <a href="{{ route('crear.incidencias') }}" class="btn btn-primary float-right"
                                                data-placement="left">
                                                {{ __('Crear Nueva Incidencia') }}
                                            </a>
                                        @endif

                                        <x-notify.modal x-data="{ id: tableControlles.idRow }" id-modal="modalIncidencias">
                                            <x-slot:modalTitle>
                                                <h4 class="text-lg">Incidencias</h4>
                                            </x-slot:modalTitle>
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{asset("assets/team/scripts/tables/servicios/soportetecnico/incidencias.js")}}"></script>
                                @endpush                             
