<div class="d-flex text-center gap-4 p-2 m-2">
   <div>
      <h5>¿Está seguro de eliminar el permiso seleccionado?</h5>
      <p>¡Al confirmar la solicitud se revocará el Permiso !</p>
   </div>
</div>

<div class="d-flex justify-content-center gap-4 p-2 m-2">
   <div class="p-2 bd-highlight"><a class="btn btn-success" href="{{ route('permiso.delete_confirm',$id) }}">Si</a></div>
