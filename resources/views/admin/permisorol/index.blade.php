                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-xl-12 col-sm-12 mb-4">
                            ...
                            <x-tables.bo-table :data="$permisos_rol" title="LISTAS DE ROLES PERMISOS" data-id="table" data-toolbar="#toolbar"
                                ...
                                <x-slot:headerActions>
                                    ...
                                    <div class="float-right">
                                       ...
                                       <!-- @if ($actionsBlade->can_create > 0)
                                            <a href="{{ route('permiso.rol.create') }}" class="btn btn-primary float-right"
                                                data-placement="left">
                                                {{ __('Asignar un Permiso a un Rol') }}
                                            </a>
                                        @endif-->
                                         
                                        <x-notify.modal x-data="{ id: tableControlles.idRow }" id-modal="modalPermisoRol">
                                            <x-slot:modalTitle>
                                                <h4 class="text-lg">Permisos Roles</h4>
                                            </x-slot:modalTitle>
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{asset("assets/team/scripts/tables/permisorol.js")}}"></script>
                                @endpush
