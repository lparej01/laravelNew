                        ...
                        <div class="col-xl-12 col-sm-12 mb-4" x-data="{ open: window.user_id }">
                            <x-tables.bo-table :data="$users" title="Gestión de Usuarios" data-id="table" data-toolbar="#toolbar"
                                ...
                                <x-slot:headerActions>
                                    ...
                                    <div class="float-right">
                                        ...
                                        @endif
                                         ...
                                         <x-notify.modal x-data="{ id: tableControlles.idRow }" id-modal="modalUser">
                                            <x-slot:modalTitle>
                                                <h4 class="text-lg">Usuarios</h4>
                                            </x-slot:modalTitle>
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{ asset("assets/team/scripts/tables/users.js") }}"></script>
                                @endpush
