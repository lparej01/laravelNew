    ...
    <section>
        <div class="container-fluid">
            <div class="page-header min-height-150 border-radius-xl"
                style="background-image: url('{{ asset("assets/team/img/curved-images/curved-6.jpg") }}'); background-position-y: 50%;">
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                         @if ($user->images == null)
                    <img id="imagen" src ="{{ asset('storage').'/imagenes/avatar.png'}}"  class="rounded" width="50" height="70" >
                    @else
                    <img id="imagen" src ="{{ asset('storage').'/'.$user->images}}"  class="rounded" width="50" height="70" >
                     @endif 
        ...
        <div class="container-fluid py-4">
            ...
            <x-forms.template-form form-redirect-back="{{ route('user.list') }}"
                form-route="{{ route('update.user', ['id' => $user->id]) }}" form-method="POST" enctype="multipart/form-data">
                     @csrf
                <x-slot:formHeader>
                    <span class="align-self-center">Editar usuario</span>
                </x-slot:formHeader>
                <x-slot:formBody>
