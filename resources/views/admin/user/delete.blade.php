<div class="d-flex justify-content-center gap-4 p-2 m-2">
   <div><h4 class="text-lg">¿Está seguro de deshabilitar el usuario seleccionado?</h4></div>
</div>

<div class="d-flex justify-content-center gap-4 p-2 m-2">
   <div class="p-2 bd-highlight"><a class="btn btn-success" href="{{ route('user.disable',$id) }}">Si</a></div>
