<div class="d-flex text-center gap-4 p-2 m-2">
   <div>
      <h5>¿Está seguro de eliminar el menu seleccionado?</h5>
      <p>¡Al confirmar la solicitud se revocará el Menu !</p>
   </div>
</div>

<div class="d-flex justify-content-center gap-4 p-2 m-2">
   <div class="p-2 bd-highlight"><a class="btn btn-success" href="{{ route('menu.delete_confirm',$id) }}">Si</a></div>
