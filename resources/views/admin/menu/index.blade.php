                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-xl-12 col-sm-12 mb-4">
                            ...
                            <x-tables.bo-table :data="$menus" title="Listado de Menu" data-id="table" data-toolbar="#toolbar"
                                ...
                                <x-slot:headerActions>
                                    ...
                                    <div class="float-right">
                                         @if ($actionsBlade->can_create > 0)
                                            <a href="{{ route('create_menu') }}" class="btn btn-primary float-right"
                                                data-placement="left">
                                                {{ __('Crear Nuevo Menu') }}
                                            </a>
                                            <br><br>
                                            ...
                                            data-placement="left">
                                            {{ __('Gestionar Menú Dinamico') }}
                                            </a>
                                        @endif

                                        <x-notify.modal x-data="{ id: tableControlles.idRow }" id-modal="modalMenu">
                                            <x-slot:modalTitle>
                                                <h4 class="text-lg">Menus</h4>
                                            </x-slot:modalTitle>
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{asset("assets/team/scripts/tables/menu/menu.js")}}"></script>
                                @endpush
