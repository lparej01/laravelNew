                        ...
                        <div class="col-xl-12 col-sm-12 mb-4">
                            ...
                            <x-tables.bo-table :data="$rols" title="Listados de Roles" data-id="table" data-toolbar="#toolbar"
                                ...
                                <x-slot:headerActions>
                                    ...
                                    <div class="float-right">
                                        @if ($actionsBlade->can_create > 0)
                                            <a href="{{ route('create_rol') }}" class="btn btn-primary float-right"
                                                data-placement="left">
                                                {{ __('Crear Nuevo Rol') }}
                                            </a>
                                        @endif

                                        <x-notify.modal x-data="{ id: tableControlles.idRow }" id-modal="modalRole">
                                            <x-slot:modalTitle>
                                                <h4 class="text-lg">Rol</h4>
                                            </x-slot:modalTitle>
                                ...
                                @push('scripts')
                                    ...
                                    <script src="{{asset("assets/team/scripts/tables/rol.js")}}"></script>
                                @endpush
