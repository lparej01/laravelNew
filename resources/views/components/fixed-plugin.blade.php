    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="{{ (Request::is('rtl') ? 'float-end' : 'float-start') }}">
          <h5 class="mt-3 mb-0">Configurador de GSHA</h5>
          <p>Consulte nuestras opciones de salpicadero.</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <p class="text-sm d-xl-none d-block mt-2">Puedes cambiar el tipo de sidenav sólo en la vista de escritorio.</p>
        <!-- Navbar Fixed -->
        <div class="mt-3">
        ...
        <a class="btn bg-gradient-dark w-100" href="#" target="_blank">Documentación</a>
