                    ...
                    ? [
                        {
                            ...
                            tooltip: { title: "Editar Departamento", toggle: "tooltip",
                                placement: "top",
                            },
                        },
                        {
                            ...
                            tooltip: {title:"Ver detalle del departamento", toggle: "tooltip",placement:"top"},
                            modal: {
                                target: "#modalDepartamentos",
                                toggle: "modal",
                                url: `departamentos/show/${row.id}`,
                            },
                            tooltip: {title:"Detalle departamento", toggle: "tooltip",placement:"top"},
                        },
                       
                        {
                            ...
                            tooltip: {title:"Eliminar departamento", toggle: "tooltip",placement:"top"},
                            name: 'disable',
                            iClass: "fa,fa-eraser",
